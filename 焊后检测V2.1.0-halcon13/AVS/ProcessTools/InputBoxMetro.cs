...
namespace AVS
{
    public partial class InputBoxMetro : Form
    {
        enum EnumType
        {
            中心点_Y = 0,
            ...
            测量选择 = 9,//'all', 'first', 'last'
            插值方法 = 10,// 'bicubic', 'bilinear', 'nearest_neighbor'
        }
        ...
        public InputBoxMetro()
        {
            InitializeComponent();
        }

        public InputBoxMetro(string itemName, HTuple itemOne)
        {
            InitializeComponent();
        ...
        private object CheckForParamLimit(string itemName, HTuple itemOne)
        {
            try
            {
                ...
                else if ((int)itemType == 10)
                {
                    ...
                    ComboBox Cbx = new ComboBox();
                    Cbx.Parent = this;
                    Cbx.Items.Add("bicubic");
                    Cbx.Items.Add("bilinear");
                    Cbx.Items.Add("nearest_neighbor");
                    Cbx.SelectedIndex = Cbx.Items.IndexOf((string)(itemOne.S));
            ...
            {
                MessageBox.Show("参数设置出现错误，请重新设置！\r\n" + ex.Message);
                return null;
            }
        }
    }
