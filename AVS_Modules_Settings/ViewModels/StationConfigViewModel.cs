...
namespace AVS_Modules_Settings.ViewModels
{
    public class StationConfigViewModel : BindableBase
    {
        ...
        /// 工位原始ID
        /// </summary>
        private readonly Dictionary<StationConfig, string> _originalStationIds = new Dictionary<StationConfig, string>();
        ...
        private void EnsureDefaultParamsForStation(string stationId)
        {
            ...
            foreach (var prop in properties)
            {
                ...
                {
                    expression = d.ToString(System.Globalization.CultureInfo.InvariantCulture);
                }
